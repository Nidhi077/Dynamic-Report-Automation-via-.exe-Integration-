#!/usr/bin/env python
# coding: utf-8
## consist avg_per_hour charts
## this version is for the new 112 & dummy stack placed in u0002 system.
## In this, Vcell is made by deleting cols that are completely 0, taking their avg-min-max-SSE,
## then deleting all vcell cols in each file and then combining the files.
...
def create_Vcell_data(sys_data):
    ...
    Vcell_data['Avg_V_C1_1_C8_16'] = (Vcell_data[List_C1_1_C8_16].sum(axis=1))/len(List_C1_1_C8_16)
    Vcell_data['Max_V_C1_1_C8_16'] = Vcell_data[List_C1_1_C8_16].max(axis=1) 
    Vcell_data['Min_V_C1_1_C8_16'] = Vcell_data[List_C1_1_C8_16].min(axis=1)
...
#    Vcell_data['ASR_Stack1'] = (Vcell_data['Avg_V_C1_1-C8_16']/Vcell_data['CURRENT DENSITY'])*1000
    Vcell_data['ASR_Stack1'] = (Vcell_data['Avg_V_C1_1_C8_16']/Vcell_data['CURRENT DENSITY'])*1000

#    Vcell_data['ASR(max)_Stack1'] = (Vcell_data['Max_V_C1_1-C8_16']/Vcell_data['CURRENT DENSITY'])*1000
    Vcell_data['ASR(max)_Stack1'] = (Vcell_data['Max_V_C1_1_C8_16']/Vcell_data['CURRENT DENSITY'])*1000
...
#     print(csv_file_list)
    ...
    #calculating that which cells are running in this 112 stack by deleting those who have 0 in entire column
