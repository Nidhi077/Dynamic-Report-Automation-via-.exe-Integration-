#!/usr/bin/env python
# coding: utf-8
# this version has just a change of timeperiod considered for a databreak - changed it from 5 mins to 1 hour
# In[4]:
...
def plot_cd(Vcell_data, image_folder_name):
    ...
    avg_cd_per_hour = Vcell_data.groupby(['date_&_hrs'])['CURRENT DENSITY'].mean().reset_index()
    Current_Density = go.Scattergl(
                           x = avg_cd_per_hour['date_&_hrs'],
    ...
    fig0.update_layout(xaxis = dict(titlefont = dict(size = 18), tickfont = dict(size = 18), tickformat = "%d-%b"),
...
def avg_min_max_stack_v(Vcell_data, image_folder_name):

    avg_per_hour = Vcell_data.groupby(['date_&_hrs'])[['CURRENT DENSITY','Avg_V_C1_1-C4_16','Avg_V_C5_1-C8_16','Avg_V_C9_1-C12_16','Avg_V_C13_1-C16_16',
                                                         'Max_V_C1_1-C4_16','Max_V_C5_1-C8_16','Max_V_C9_1-C12_16','Max_V_C13_1-C16_16',
                                                         'Min_V_C1_1-C4_16','Min_V_C5_1-C8_16','Min_V_C9_1-C12_16','Min_V_C13_1-C16_16']].mean().reset_index()
    # define a new figure
    ...
    Avg_StackU1 = go.Scattergl(
                           ...
                           y = avg_per_hour['Avg_V_C1_1-C4_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           legendgroup=1,
                           name = 'U1 (V)',
                           marker=dict(color = color_dict['U1'])
                           #yaxis = 'y1'
                           #text = df.column (this is the info displayed on hover)
                           )
    Avg_StackU2 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Avg_V_C5_1-C8_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'U2 (V)',
                           legendgroup=2,
    ...
    Avg_StackL2 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Avg_V_C9_1-C12_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'L2 (V)',
                           legendgroup=3,
    ...
    Avg_StackL1 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Avg_V_C13_1-C16_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'L1 (V)',
                           legendgroup=4,
    ...
    fig.add_trace(Avg_StackU1, row=1, col=1)
    fig.add_trace(Avg_StackU2, row=1, col=1)
    fig.add_trace(Avg_StackL2, row=1, col=1)
    fig.add_trace(Avg_StackL1, row=1, col=1)
    
    # defining max voltage traces
    Max_StackU1 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Max_V_C1_1-C4_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'U1 (V)',
                           legendgroup=1,
    ...
    Max_StackU2 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Max_V_C5_1-C8_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'U2 (V)',
                           legendgroup=2,
    ...
    Max_StackL2 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Max_V_C9_1-C12_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'L2 (V)',
                           legendgroup=3,
    ...
    Max_StackL1 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Max_V_C13_1-C16_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'L1 (V)',
                           legendgroup=4,
    ...
    #adding traces to the figure
    fig.add_trace(Max_StackU1, row=2, col=1)
    fig.add_trace(Max_StackU2, row=2, col=1)
    fig.add_trace(Max_StackL2, row=2, col=1)
    fig.add_trace(Max_StackL1, row=2, col=1)
   
   # defining Min voltage traces 
    Min_StackU1 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Min_V_C1_1-C4_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'U2 (V)',
                           legendgroup=1,
    ...
    Min_StackU2 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Min_V_C5_1-C8_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'U2 (V)',
                           legendgroup=2,
    ...
    Min_StackL2 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Min_V_C9_1-C12_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'L2 (V)',
                           legendgroup=3,
    ...
    Min_StackL1 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['Min_V_C13_1-C16_16'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'L1 (V)',
                           legendgroup=4,
    ...
    #adding traces to the figure
    fig.add_trace(Min_StackU1, row=3, col=1)
    fig.add_trace(Min_StackU2, row=3, col=1)
    fig.add_trace(Min_StackL2, row=3, col=1)
    fig.add_trace(Min_StackL1, row=3, col=1)
    
    # defining current density
    Current_Density = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['CURRENT DENSITY'],
                           mode = 'markers',
    #                        mode = 'lines',
                           name = 'i (A/c'+'m\u00b2)',
...
def ASR_chart(Vcell_data, image_folder_name):
    ...
    avg_per_hour = Vcell_data.groupby(['date_&_hrs'])[['CURRENT DENSITY',
                    'ASR_Stack1', 'ASR_Stack2', 'ASR_Stack3', 'ASR_Stack4',
                    'ASR(max)_Stack1', 'ASR(max)_Stack2', 'ASR(max)_Stack3', 'ASR(max)_Stack4']].mean().reset_index()
    # define a new figure
    ...
    max_ASR_StackU1 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['ASR(max)_Stack1'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'U1 (V)',
                           legendgroup=1,
...
def pressure_and_conductivity(sys_data, image_folder_name):
    avg_per_hour = sys_data.groupby(['date_&_hrs'])[['PRT 102', 'PRT 401', 'COS 101']].mean().reset_index()
        # define a new figure
    Pressure_102 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['PRT 102'],
                           mode = 'markers',
                           #mode = 'lines',
                           name = 'PRT 102 (bar)',
                           yaxis = 'y1'
...
def ttc_ktc_lvl_sensors(sys_data, image_folder_name):
    avg_per_hour = sys_data.groupby(['date_&_hrs'])[['TTC 101', 'TTC 102', 'TTC 301', 'KTC 401', 'LVL 101']].mean().reset_index()    
    TTC101 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['TTC 101'],
                           mode = 'markers',
                           #marker=dict(size=3),
                           #mode = 'lines',
                           name = 'TTC 101 (°C)',
...
def HYS102_vs_LVL101(sys_data, image_folder_name):
    ...
    avg_per_hour = sys_data.groupby(['date_&_hrs'])[['HYS 102', 'PRT 401','CURRENT DENSITY','LVL 101']].mean().reset_index()    

    HYS102 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['HYS 102'],
                           mode = 'markers',
...
def hyd_and_water_sensor(sys_data, image_folder_name):
    sys_data = sys_data[(sys_data['MP STATE']=='STACK PWR') & (sys_data['MS STATE']=='ARMED')]
    avg_per_hour = sys_data.groupby(['date_&_hrs'])[['HYS 101', 'HYS 102', 'HYS 401','HYS 501','OXS 101','CURRENT DENSITY']].mean().reset_index()    
    HYS101 = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['HYS 101'],
                           mode = 'markers',
                           #marker=dict(size=3),
                           #mode = 'lines',
                           name = 'HYS 101 (% LEL)',
...
def LWC_Pressure_and_PMP_State(sys_data, image_folder_name):
    #avg_per_hour = sys_data.groupby(['date_&_hrs'])[['PRT 704', 'PRT 705','PMP 102']].mean().reset_index()
    # define a new figure
    ...
    PRT704 = go.Scattergl(
                           x = sys_data['date_&_hrs'],
                           y = sys_data['PRT 704'],
                           mode = 'markers',
                           marker=dict(color = color_dict['PRT 704']),
    #                        mode = 'lines',
                           name = 'PRT 704 (bar)',
                           #yaxis = 'y1'
                           #text = df.column (this is the info displayed on hover)
    ...
    PRT705 = go.Scattergl(
                           ...
                           y = sys_data['PRT 705'],
                           mode = 'markers',
                           marker=dict(color = color_dict['PRT 705']),
    #                        mode = 'lines',
                           name = 'PRT 705 (bar)',
                           #yaxis = 'y1'
                           #text = df.column (this is the info displayed on hover)
    ...
    PMP102_a  = go.Scattergl(
                            ...
                            mode = 'markers',
                            marker=dict(color = color_dict['PMP 102']),
                            legendgroup=1,
                            #mode = 'lines',
                            name = 'PMP State',
                            #showlegend=False,
...
def stack_specific_energy(Vcell_data, image_folder_name):
    ...
    avg_per_hour = Vcell_data.groupby(['date_&_hrs'])[['CURRENT DENSITY','STACK SPECIFIC ENERGY']].mean().reset_index()    

    Stack_Specific_energy = go.Scattergl(
                           x = avg_per_hour['date_&_hrs'],
                           y = avg_per_hour['STACK SPECIFIC ENERGY'],
                           mode = 'markers',
                           #marker=dict(size=3),
                           #mode = 'lines',
...
#               print(type(cell_content))
    ...
    column2_x = Inches(5.33 )
    #column1_x_1=Inches(0)
    # place the LHC_Stack_Specific_Energy Chart
    pic = slide.shapes.add_picture('{}/LHC_Stack_Specific_Energy.png'.format(image_folder_name), Inches(0), row2_y, width=Inches(5.48), height=height)
...
#             pic = slide.shapes.add_picture(pol_curve_file, column2_x, row1_y, width=width, height=height)
    ...
    if len(running_cell_positions) == 2:
...
#     print(csv_file_list)
    sys_data = pd.concat([pd.read_csv(f, on_bad_lines='warn') for f in csv_file_list ], ignore_index=True)
...
# running the functions for creating dfs & charts
    ...
    avg_min_max_stack_v(Vcell_data, image_folder_name)
    ASR_chart(Vcell_data, image_folder_name)
    #max_ASR_chart(Vcell_data, image_folder_name)
    ...
    #PRT705_and_PMP_state(sys_data, image_folder_name)
    ...
    #if T1/T2 is empty, then do not run pol curve functions else run them
    if len(T1) == 0:
        pass
...
#%% sandbox
# csv_file_list = ['C:/Users/nidhi.dubey/Documents/Lotus_system_data/extracted_files/DATA_U6_2023_05_20.csv',
#                  'C:/Users/nidhi.dubey/Documents/Lotus_system_data/extracted_files/DATA_U6_2023_05_26.csv',
#                  'C:/Users/nidhi.dubey/Documents/Lotus_system_data/extracted_files/DATA_U6_2023_05_27.csv']
# stack_info_fn = 'C:/Users/nidhi.dubey/Documents/Lotus_system_data/Stack_Information.xlsx'
# output_dir = 'C:/Users/nidhi.dubey/Documents/Lotus_system_data/updates'
# unit_name = 'SPR0001'
