...
def create_Vcell_data(sys_data):
    ...
    Vcell_data['Avg_V_C1_1-C8_16'] = (Vcell_data[List_C1_1_C8_16].sum(axis=1))/len(List_C1_1_C8_16)
    Vcell_data['Max_V_C1_1-C8_16'] = Vcell_data[List_C1_1_C8_16].max(axis=1) 
    Vcell_data['Min_V_C1_1-C8_16'] = Vcell_data[List_C1_1_C8_16].min(axis=1)
...
def avg_min_max_stack_v(sys_data,image_folder_name):
    ...
    std_dev_trace = go.Scatter(
        ...
        line=dict(color='rgb(255, 127, 14)', width=0.5),
        connectgaps=False
        )
...
#%%
# def avg_min_max_stack_v_old_multipleaxis(Vcell_data, image_folder_name):
...
def avg_min_max_stack_v_old_singleaxis2(sys_data, image_folder_name):
    ...
    Max_StackL1 = go.Scattergl(
                            x = avg_per_hour['Date'],
                            y = avg_per_hour['Max_V_C1_1-C8_16'],
                            mode = 'markers',
                            #mode = 'lines',
                            name = 'Max V',
                            #legendgroup=3,
    ...
    fig.write_image('{}/LHC_Stack_Voltage_&_Current_Density2.png'.format(image_folder_name), engine="orca")
    fig.write_html('{}/LHC_Stack_Voltage_&_Current_Density2.html'.format(image_folder_name), include_plotlyjs=('cdn'))
    # fig7.show()
    print('exported LHC_Stack_Voltage chart')    
...
def stack_specific_energy_new(sys_data, image_folder_name):
    ...
    #                                     title = 'Date',
                ...
                yaxis2= dict(title='Cd (A/c'+'m\u00b2)',
                                     ...
                                     rangemode='tozero'),
    #                                  range=[0,600]),
                legend = dict(xanchor="right",x=1.27,yanchor="top", y =0.8, bgcolor = 'rgba(0,0,0,0)'),
                template = 'simple_white',
                font = dict(size = 18),
                width=850
                )
...
# running the functions for creating dfs & charts
    ...
    avg_min_max_stack_v_old_singleaxis2(sys_data, image_folder_name)
